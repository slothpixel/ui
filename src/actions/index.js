...
export const getPlayer = accountId => action('player', process.env.REACT_APP_API_HOST, `api/player/${accountId}`);
export const getGuild = accountId => action('guild', process.env.REACT_APP_API_HOST, `api/guild/${accountId}`);
